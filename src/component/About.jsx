...
const About = () => {
  ...
  return (
  <div>
  <section className="section-1 relative md:top-[70px]  " id="about">
  ...
  <button className="bg-[#000] text-[#fff] font-brico font-normal    md:pl-6 md:pr-6 md:pt-3  pr-4 pl-4 pt-2 pb-2 md:pb-3 relative left-[10px] top-[10px] hover:bg-zinc-500 ">Read more</button>
  </div>
  </div>
